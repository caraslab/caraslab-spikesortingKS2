function data = caraslab_TDTbin2mat(BLOCK_PATH, varargin)
...
% MML edit: add this flag as input for optionally chunking the conversion
% by using samples instead of time
% IS_TIME = 1;
...
if ~useOutsideHeaders
    ...
    if IS_TIME
        ...
        fprintf('read from sample=%d to t=%d\n', T1, lastRead);
    end
